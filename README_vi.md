...
· [**📸 Demo & Ảnh chụp màn hình**](#-demo--ảnh-chụp-màn-hình) · [**🚀 Khởi động nhanh**](#-khởi-động-nhanh) · [**🤖 Cấu hình MCP**](#-mcp--vibe-coding)
...
**Tùy chọn 1: Pull image có sẵn từ GitHub Container Registry**

```bash
# Bản mới nhất (nhánh main)
